...
module.exports = {
  ...
  _defaultMessage: {
    ...
    tr: ' "{{=e.keyword}}" anahtar kelimesi doğrulamasını geçmelidir',
  ...
  additionalItems: {
    ...
    tr: "{{#def.n}}{{=n}} öğeden fazla olmamalıdır",
  ...
  anyOf: {
    ...
    tr: '"anyOf" içindeki şemalardan biriyle eşleşmelidir',
  ...
  dependencies: {
    ...
    tr: "{{#def.n}}{{=e.params.property}} özelliği varsa, {{=e.params.deps}} bulunmalıdır",
  ...
  format: {
    ...
    tr: '"{{=e.params.format}}" biçimiyle eşleşmelidir',
  ...
  minItems: {
    ...
    tr: "{{#def.n}}{{=n}} öğeden az olmamalıdır",
    zh: "{{#def.n}}不应少于 {{=n}} 个项",
  ...
  maxLength: {
    ...
    tr: "{{#def.n}}uzunluk {{=n}} karakterden fazla olmamalıdır",
    zh: "{{#def.n}}不应多于 {{=n}} 个字符",
  ...
  minLength: {
    ...
    tr: "{{#def.n}}uzunluk {{=n}} karakterden az olmamalıdır",
    zh: "{{#def.n}}不应少于 {{=n}} 个字符",
  ...
  multipleOf: {
    ...
    tr: "{{=e.params.multipleOf}} katı olmalıdır",
  ...
  not: {
    ...
    tr: '"not" içindeki şemaya göre geçerli olmamalıdır',
    zh: '不应当匹配 "not" schema',
  ...
  oneOf: {
    ...
    tr: '"oneOf" içindeki şemalardan yalnızca biriyle eşleşmelidir',
  ...
  pattern: {
    ...
    tr: '"{{=e.params.pattern}}" desenine uymalıdır',
  ...
  required: {
    ...
    tr: "zorunlu özellik {{=e.params.missingProperty}} bulunmalıdır",
  ...
  unevaluatedProperties: {
    ...
    tr: "değerlendirilmemiş özellik olmamalıdır",
    zh: "不允许存在未求值的属性",
    "zh-TW": "不應該有未驗證的屬性",
  },
  unevaluatedItems: {
  ...
  uniqueItems: {
    ...
    tr: "yinelenen öğeler olmamalıdır (öğeler ## {{=e.params.j}} ve {{=e.params.i}} özdeştir)",
  ...
  patternRequired: {
    ...
    tr: '"{{=e.params.missingPattern}}" desenine uyan bir özellik olmalıdır',
  ...
  const: {
    ...
    tr: "sabit değere eşit olmalıdır",
    zh: "应当等于常量",
    "zh-TW": "應該等於常數",
  },
  contains: {
  ...
  if: {
    ...
    tr: '"{{=e.params.failingKeyword}}" şemasına uymalıdır',
  ...
  discriminator: {
    ...
    tag: {
      ...
      tr: 'etiket "{{=e.params.tag}}" dizge olmalıdır',
    ...
    mapping: {
      ...
      tr: 'etiket "{{=e.params.tag}}" değeri oneOf içinde olmalıdır',
